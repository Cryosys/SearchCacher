...
{
    public class HashVsStringTest
    {
        public HashVsStringTest()
        {
        }
    ...
    public class HashVsString
    {
        ...
        public HashVsString()
        {
            ...
            {
                _texts[i] = TestDataGenerator.RandomString(TestDataGenerator.Random.Next(18, 250));
                _compareTexts[i] = TestDataGenerator.RandomString(TestDataGenerator.Random.Next(18, 250));
